...
public class PeopleService {
    ...
    public List<Person> findAnyByName(String keyword) {
        Optional<List<Person>> resultSearch = peopleRepository.findPersonByNameContainsIgnoreCase(keyword);
        return resultSearch.orElse(null);
    }

    @Transactional
    public Person findByEmail(String email) {
        Optional<Person> foundPerson = peopleRepository.findPersonByEmailIgnoreCase(email);
        return foundPerson.orElse(null);
    }
